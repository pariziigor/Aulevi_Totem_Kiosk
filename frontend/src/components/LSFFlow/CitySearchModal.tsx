...
export const CitySearchModal: React.FC<CitySearchModalProps> = ({
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0, y: 30 }}
      className="fixed inset-0 bg-slate-900/80 backdrop-blur-md z-50 flex items-center justify-center p-3 md:p-4 xl:p-8"
    >
      <div className="bg-slate-50 w-full max-w-5xl rounded-2xl md:rounded-[2rem] shadow-2xl flex flex-col overflow-hidden h-[90vh] lg:h-auto lg:max-h-[1000px]">
        ...
        <div className="p-4 md:p-6 bg-white border-b border-slate-100 flex-none">
          <div className="w-full bg-slate-50 border-2 border-orange-500 ring-2 md:ring-4 ring-orange-50 rounded-xl md:rounded-2xl h-14 md:h-16 xl:h-20 flex items-center px-4 md:px-6 shadow-inner">
            <input
              type="text"
              value={searchValue}
