...
export const ProductDetails: React.FC<ProductDetailsProps> = ({
  ...
  return (
    <div className="flex flex-col w-full flex-1 min-h-0 gap-4 md:gap-5 lg:gap-5">
      ...
      <div className="flex flex-col lg:flex-row gap-5 md:gap-6 lg:gap-8 2xl:gap-10 w-full lg:flex-1 lg:min-h-0">
        {/* Image Section */}
        <div className="relative flex items-center justify-center bg-slate-900 rounded-[1.5rem] md:rounded-[2rem] lg:rounded-[2rem] overflow-hidden shadow-inner border border-slate-200 w-full h-[42vh] md:h-[52vh] lg:h-auto lg:flex-[1.35] lg:min-h-0">
          <button
            onClick={(e) => {
              e.stopPropagation();
              onPrevImage();
        ...
        {/* Details Section */}
        <div className="flex-1 flex flex-col gap-4 lg:gap-5 w-full h-auto lg:h-full lg:min-h-0">
          <div className="bg-white border border-slate-200 rounded-[1.5rem] md:rounded-[2rem] lg:rounded-[2rem] p-4 md:p-5 lg:p-6 shadow-sm flex flex-col h-auto lg:flex-1 lg:min-h-0 relative lg:overflow-hidden">
